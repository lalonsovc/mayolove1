Swal.fire({
    ...
    text:'¿Que te te pedi que te regalara ultimamente porque el mio se rompio?',
    // html:
    icon:'question',
...
function pregunta_1(){
if (pregunta1.value === "taza" || pregunta1.value === "Una taza" || pregunta1.value === "una taza" || pregunta1.value === "Una Taza"){
    Swal.fire({
